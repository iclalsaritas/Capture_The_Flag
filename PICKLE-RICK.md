...
##### whoami dedik root olmuşuz harbiden. cd /root dedik, ls -la yaptık ve aradığımız tam olarak karşımızda.cat 3rd.txt dedik ve Rick arkadaşımızın ibretlik hikayesine katkımız son bulmuş oldu.
